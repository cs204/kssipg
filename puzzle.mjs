...
знания0.добавить (new Эквивалентность(new И(АЛжец, АРыцарь), АРыцарь));
...
знания3.добавить (new Эквивалентность (new Эквивалентность(БЛжец, БРыцарь),АЛжец));
знания3.добавить (new Эквивалентность (new Эквивалентность(ВЛжец, ВРыцарь),ВЛжец));
